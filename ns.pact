...
(namespace 'test)
(define-keyset "test.ns-admin-keyset" (read-keyset 'ns-admin-keyset))
(define-keyset "test.ns-operate-keyset" (read-keyset 'ns-genesis-keyset))
...
(module ns GOVERNANCE
  ...
  (defcap GOVERNANCE ()
    (enforce-keyset "test.ns-admin-keyset"))

  (defcap OPERATE ()
    (enforce-keyset "test.ns-operate-keyset"))
